...
- While the sonnets normally have 14 lines each, Sonnet 99 has 15 lines, and Sonnet 126 has 12 lines.
- Some readings in the modern version may be substantially different from the original publication (eg. Line 2 of Sonnet 146). [See here](https://www.folger.edu/explore/shakespeares-works/shakespeares-sonnets/textual-notes/) for Folger's editing choices.

To do: 
- Add alternate versions of sonnets that have them
